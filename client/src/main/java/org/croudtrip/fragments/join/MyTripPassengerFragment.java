 ...
 * @author Vanessa Lange, Alexander Popp
 */
public class MyTripPassengerFragment extends SubscriptionFragment {

    //********************************************************************//
    //                          IMPORTANT                                 //
    //  This file is not yet in use. It will replace JoinDrivingFragment  //
    //  as soon as all SuperTrip related functionality can be used and    //
    ...
    @InjectView(R.id.rv_my_trip_passenger_drivers)
    private RecyclerView recyclerView;

    private ProgressWheel mapProgressBar;
    private ProgressWheel driversProgressBar;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_my_trip_passenger, container, false);
    }
    ...
    public void onViewCreated( View view, Bundle savedInstanceState ) {
        ...
        View header = view.findViewById(R.id.ll_my_trip_passenger_info);
        ...
        driversProgressBar = (ProgressWheel) adapter.getHeader().findViewById(R.id.pb_my_trip_drivers_progressBar);
    ...
    /**
     * Downloads the current request and processes its information with the {@link LoadRequestSubscriber}
     */
    private synchronized void loadRequest() {

        // UI
        mapProgressBar.setVisibility(View.VISIBLE);
        // Don't show spinner again, looks ugly with already filled adapter

        // TODO: call new server method to get the current trip with all its drivers etc.
        //subscriptions.add(null).subscribe(new LoadRequestSubscriber());
    }
    ...
    private void loadDrivers() {
        subscriptions.add(tripsResource.getJoinRequests(false)
                        ...
                        .subscribe(new ImportantDriversSubscriber())
        );
    }
    ...
    /**
     * This Subscriber loads the current trip on the map and loads the drivers
     */
    private class LoadRequestSubscriber extends Subscriber<JoinTripRequest> {

        @Override
        public void onNext(final JoinTripRequest request) {

            if (request == null) {
                throw new NoSuchElementException(getString(R.string.my_trip_passenger_error_no_trip));
            }

            Timber.d("Received JoinTripRequest with ID " + request.getId());

            // Remember the requestID for later and load the drivers for this request
        ...
        public void onError(Throwable throwable) {
            ...
            driversProgressBar.setVisibility(View.GONE);
            Timber.e(throwable.getMessage());
            Toast.makeText(getActivity(), getString(R.string.load_trip_passenger_failed), Toast.LENGTH_LONG).show();
        }
    }


    /**
     * This Subscriber subscribes to the related drivers to this trip
     ...
     */
    private class ImportantDriversSubscriber extends Subscriber<List<JoinTripRequest>> {
        // TODO
